...
function Button({
  ...
  return (
    <ButtonPrimitive
      data-slot="button"
      // `render` troca o elemento renderizado (ex.: <Link>) por algo que não
      // é um <button> nativo — sem isso, o Base UI espera um <button> real e
      // gera erro em dev quando o elemento final é um <a>.
